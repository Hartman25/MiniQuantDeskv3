...
def create_default_protections() -> ProtectionManager:
    """
    Create protection manager with sensible defaults.
    
    Returns:
        ProtectionManager with standard protections configured
    """
    ...
    # Stoploss guard: 3 consecutive losses = 1 hour cooldown
    ...
    # Max drawdown: 15% drawdown = 24 hour stop
    manager.add_protection(
    ...
    # Cooldown: $500 loss = 30 minute pause
    manager.add_protection(
        CooldownPeriod(
    ...
    logger.info("Default protections configured")
    return manager
